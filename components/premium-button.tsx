...
const Box = () => {
  ...
  return (
    <div className="absolute inset-y-0 left-2 my-auto size-7 rounded-lg  flex flex-col justify-center items-center gap-px transition-all duration-400 ease-out shadow-sm">
      {[0, 1, 2, 3, 4].map((row) => (

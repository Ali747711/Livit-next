...
const TopProperties = ({ initialInput = defaultInput }: TopPropertiesProps) => {
  ...
  if (loading && properties.length === 0) {
    return (
      <>
        ...
        {/* Desktop skeleton */}
        <div className="hidden md:flex gap-2" style={{ height: "460px" }}>
          {[0, 1, 2, 3, 4].map((i) => (
            <div
              key={i}
  ...
  if (!loading && properties.length === 0) {
    return (
      ...
      >
        <p style={{ color: "#9ca3af" }}>No new properties found</p>
      </div>
    );
  }
    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:hidden">
        {properties.map((property, idx) => {
          ...
          const location = property.propertyAddress || property.propertyLocation;
          ...
          return (
            ...
            >
              ...
              <div className="relative aspect-4/3 overflow-hidden">
                ...
                {idx === 0 && (
                  <span
                    className="absolute top-3 left-3 text-[9px] font-extrabold px-2.5 py-1 rounded-full uppercase tracking-widest"
                ...
                {/* Type badge (non-first items) */}
                {idx !== 0 && property.propertyType && (
              ...
              {/* Card body */}
              <div className="p-5">
                {/* Type badge as text chip (first item uses NEW badge above) */}
                {idx === 0 && property.propertyType && (
                  <span
                    ...
                    style={{
                      ...
                      color: "#F25912",
                      border: "1px solid rgba(242,89,18,0.25)",
                    }}
                  >
                    {property.propertyType}
                  </span>
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  >
                    ...
                    <span
                      ...
                      onMouseEnter={(e) => {
                        (e.currentTarget as HTMLSpanElement).style.background = "#F25912";
                      }}
                      onMouseLeave={(e) => {
                        (e.currentTarget as HTMLSpanElement).style.background = "#222831";
                      }}
                    >
            ...
            >
              ...
              <div
                ...
                style={{
                  background: isExpanded
                    ? "linear-gradient(to top, rgba(10,10,10,0.94) 0%, rgba(0,0,0,0.3) 50%, rgba(0,0,0,0.04) 100%)"
                    : "linear-gradient(to top, rgba(10,10,10,0.6) 0%, transparent 55%)",
                  transition: "background 0.4s ease",
                }}
              />

              {/* ── Collapsed: thin orange accent line + vertical title ── */}
              <div
              ...
              >
                ...
                <div
                  ...
                  style={{ width: "2px", height: "40px", background: "#F25912" }}
                />
              ...
              >
                ...
                <div className="flex items-end justify-between">
                  ...
                  {/* White circle arrow CTA */}
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      router.push(`/property/details?id=${property._id}`);
                    }}
                    className="flex items-center gap-2.5 group/cta"
                  >
                    <span
